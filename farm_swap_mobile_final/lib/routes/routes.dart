...
import 'package:farm_swap_mobile_final/clare_modules/pages/forgot_password/screens/forgot_password.dart';
...
/*Route method */
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case farmerdisputepage:
        return MaterialPageRoute(
            builder: (context) => const FarmerDisputePage());

      case consumerdisputepage:
        return MaterialPageRoute(
            builder: (context) => const ConsumerDisputePage());
