...
class ConsumerNotificationsBid extends StatefulWidget {
  const ConsumerNotificationsBid({super.key});

  @override
  State<ConsumerNotificationsBid> createState() =>
      _ConsumerNotificationsBidState();
}

class _ConsumerNotificationsBidState extends State<ConsumerNotificationsBid> {
...
ConsumerNotificationQuerry notif = ConsumerNotificationQuerry();
...
Widget _buildNotificationLists() {
  return StreamBuilder<QuerySnapshot>(
    stream: FirebaseFirestore.instance
        .collectionGroup('consumernotifications')
        .snapshots(),
