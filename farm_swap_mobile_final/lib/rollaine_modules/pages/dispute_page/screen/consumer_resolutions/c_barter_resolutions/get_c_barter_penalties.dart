...
import 'package:farm_swap_mobile_final/rollaine_modules/pages/dispute_page/screen/consumer_resolutions/c_barter_resolutions/c_barter_penalties_details.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:intl/intl.dart';

class CBarterPenalties extends StatefulWidget {
  const CBarterPenalties({super.key});

  @override
  State<CBarterPenalties> createState() => _CBarterPenaltiesState();
}

class _CBarterPenaltiesState extends State<CBarterPenalties> {
  @override
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Navigator.of(context).push(MaterialPageRoute(
            builder: (context) {
              return ConsumerBarterPenaltiesDetails(
                itemUrl: itemUrl,
