...
class ConsumerBarterPenaltiesDetails extends StatefulWidget {
  const ConsumerBarterPenaltiesDetails({
    super.key,
  ...
  @override
  State<ConsumerBarterPenaltiesDetails> createState() => _ConsumerBarterPenaltiesDetailsState();
}

class _ConsumerBarterPenaltiesDetailsState extends State<ConsumerBarterPenaltiesDetails> {
