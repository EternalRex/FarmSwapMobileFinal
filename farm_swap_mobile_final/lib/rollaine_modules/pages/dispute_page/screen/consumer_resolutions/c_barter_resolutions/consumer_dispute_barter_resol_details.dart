...
class ConsumerBarterResolutionDetails extends StatefulWidget {
  const ConsumerBarterResolutionDetails({
    super.key,
  ...
  @override
  State<ConsumerBarterResolutionDetails> createState() => _ConsumerBarterResolutionDetailsState();
}

class _ConsumerBarterResolutionDetailsState extends State<ConsumerBarterResolutionDetails> {
