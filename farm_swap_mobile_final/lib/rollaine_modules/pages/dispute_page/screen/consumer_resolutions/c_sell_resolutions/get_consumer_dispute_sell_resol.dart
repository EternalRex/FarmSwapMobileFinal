...
import 'package:farm_swap_mobile_final/rollaine_modules/pages/dispute_page/screen/consumer_resolutions/c_sell_resolutions/coonsumer_sell_resol_details.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:intl/intl.dart';

class GetConsumerSellResolution extends StatefulWidget {
  const GetConsumerSellResolution({super.key});

  @override
  State<GetConsumerSellResolution> createState() => _GetConsumerSellResolutionState();
}

class _GetConsumerSellResolutionState extends State<GetConsumerSellResolution> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance
          .collection('sample_CSellResolution')
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) {
                return ConsumerSellingResolutionDetails(
