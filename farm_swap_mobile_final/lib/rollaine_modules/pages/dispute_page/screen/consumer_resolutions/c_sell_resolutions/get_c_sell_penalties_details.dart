...
class ConsumerSellPenaltiesDetails extends StatefulWidget {
  const ConsumerSellPenaltiesDetails({
    super.key,
  ...
  @override
  State<ConsumerSellPenaltiesDetails> createState() => _ConsumerSellPenaltiesDetailsState();
}

class _ConsumerSellPenaltiesDetailsState extends State<ConsumerSellPenaltiesDetails> {
