...
import 'package:farm_swap_mobile_final/rollaine_modules/pages/dispute_page/screen/consumer_resolutions/c_sell_resolutions/get_c_sell_penalties_details.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:intl/intl.dart';

class GetCSellPenalties extends StatefulWidget {
  const GetCSellPenalties({super.key});

  @override
  State<GetCSellPenalties> createState() => _GetCSellPenaltiesState();
}

class _GetCSellPenaltiesState extends State<GetCSellPenalties> {
  @override
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) {
                return ConsumerSellPenaltiesDetails(
