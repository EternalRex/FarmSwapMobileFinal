...
class ConsumerSellingResolutionDetails extends StatefulWidget {
  const ConsumerSellingResolutionDetails({
    super.key,
  ...
  @override
  State<ConsumerSellingResolutionDetails> createState() => _ConsumerSellingResolutionDetailsState();
}

class _ConsumerSellingResolutionDetailsState extends State<ConsumerSellingResolutionDetails> {
