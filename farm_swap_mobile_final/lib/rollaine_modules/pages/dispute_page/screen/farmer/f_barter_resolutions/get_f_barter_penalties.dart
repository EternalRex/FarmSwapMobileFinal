...
import 'package:farm_swap_mobile_final/rollaine_modules/pages/dispute_page/screen/farmer/f_barter_resolutions/f_barter_penalties_details.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:intl/intl.dart';

class GetFBarterPenalties extends StatefulWidget {
  const GetFBarterPenalties({super.key});

  @override
  State<GetFBarterPenalties> createState() => _GetFBarterPenaltiesState();
}

class _GetFBarterPenaltiesState extends State<GetFBarterPenalties> {
  @override
