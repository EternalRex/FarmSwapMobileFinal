...
import 'package:farm_swap_mobile_final/rollaine_modules/pages/dispute_page/screen/farmer/f_barter_resolutions/f_barter_resol_details.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:intl/intl.dart';

class GetFarmerBarterResolution extends StatefulWidget {
  const GetFarmerBarterResolution({super.key});

  @override
  State<GetFarmerBarterResolution> createState() => _GetFarmerBarterResolutionState();
}

class _GetFarmerBarterResolutionState extends State<GetFarmerBarterResolution> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance
          .collection('sample_fBarterResolution')
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Navigator.of(context).push(MaterialPageRoute(
            builder: (context) {
              return FarmerBarterResolutionDetails(
                itemUrl: itemUrl,
