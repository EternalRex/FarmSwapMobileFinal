...
class FarmerBarterResolutionDetails extends StatefulWidget {
  const FarmerBarterResolutionDetails({
    super.key,
  ...
  @override
  State<FarmerBarterResolutionDetails> createState() => _FarmerBarterResolutionDetailsState();
}

class _FarmerBarterResolutionDetailsState extends State<FarmerBarterResolutionDetails> {
