...
class FarmerSellResolutionDetails extends StatefulWidget {
  const FarmerSellResolutionDetails({
    super.key,
  ...
  @override
  State<FarmerSellResolutionDetails> createState() => _FarmerSellResolutionDetailsState();
}

class _FarmerSellResolutionDetailsState extends State<FarmerSellResolutionDetails> {
