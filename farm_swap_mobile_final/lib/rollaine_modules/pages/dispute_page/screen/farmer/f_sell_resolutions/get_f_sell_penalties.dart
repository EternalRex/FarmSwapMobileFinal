...
import 'package:farm_swap_mobile_final/rollaine_modules/pages/dispute_page/screen/farmer/f_sell_resolutions/f_sell_penalties_details.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:intl/intl.dart';

class GetFSellPenalties extends StatefulWidget {
  const GetFSellPenalties({super.key});

  @override
  State<GetFSellPenalties> createState() => _GetFSellPenaltiesState();
}

class _GetFSellPenaltiesState extends State<GetFSellPenalties> {
  @override
