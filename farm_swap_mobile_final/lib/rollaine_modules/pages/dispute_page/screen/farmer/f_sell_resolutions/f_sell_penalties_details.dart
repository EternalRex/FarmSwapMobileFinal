...
class FSellPenaltiesDetails extends StatefulWidget {
  const FSellPenaltiesDetails({
    super.key,
  ...
  @override
  State<FSellPenaltiesDetails> createState() => _FSellPenaltiesDetailsState();
}

class _FSellPenaltiesDetailsState extends State<FSellPenaltiesDetails> {
