...
import 'package:farm_swap_mobile_final/rollaine_modules/pages/dispute_page/screen/consumer/consumer_done_report_sale_details.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:intl/intl.dart';

class GetConsumerSellDoneReports extends StatefulWidget {
  const GetConsumerSellDoneReports({super.key});

  @override
  State<GetConsumerSellDoneReports> createState() => _GetConsumerSellDoneReportsState();
}

class _GetConsumerSellDoneReportsState extends State<GetConsumerSellDoneReports> {
  @override
...
rani e uncomment Farmer Details */
    ...
    bool isConsumerDisputed = data['isDisputed'];
