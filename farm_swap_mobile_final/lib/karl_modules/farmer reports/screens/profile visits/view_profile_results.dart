...
class ViewProfileVisits extends StatefulWidget {
  const ViewProfileVisits({super.key});

  @override
  State<ViewProfileVisits> createState() => _ViewProfileVisitsState();
}

class _ViewProfileVisitsState extends State<ViewProfileVisits> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const GetFarmerProfileVisits(),
            ),
          ],
        ),
      ),
  ...
  Future<void> getTotalProfileVisits() async {
    ...
    try {
      QuerySnapshot<Map<String, dynamic>> querySnapshot = await FirebaseFirestore.instance
          .collection('sample_FarmerProfileVisits') // Replace with your main collection
