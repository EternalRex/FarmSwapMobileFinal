...
class FarmerConsumerSellingRating extends StatefulWidget {
  const FarmerConsumerSellingRating({
    super.key,
  ...
  @override
  State<FarmerConsumerSellingRating> createState() => _FarmerConsumerSellingRatingState();
}

class _FarmerConsumerSellingRatingState extends State<FarmerConsumerSellingRating> {
