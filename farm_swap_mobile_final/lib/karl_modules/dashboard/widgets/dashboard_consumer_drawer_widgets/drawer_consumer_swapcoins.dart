...
class ConsumerSwapCoinsManagementBtn extends StatelessWidget {
  const ConsumerSwapCoinsManagementBtn({super.key});
      ...
      child: Center(
        child: Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                Navigator.of(context).pushNamed(RouteManager.consumerswapcoins);
              },
              child: DashBoardTxt(
                myText: "Swap Coins",
